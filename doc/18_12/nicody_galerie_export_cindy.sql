...
--
-- Client: localhost
-- Généré le: Mer 18 Décembre 2013 à 07:53
...
--
CREATE DATABASE IF NOT EXISTS `nicody_galerie` DEFAULT CHARACTER SET utf32 COLLATE utf32_general_ci;
USE `nicody_galerie`;
...
INSERT INTO `image` (`idimage`, `nom`, `description`, `lien`, `idcategorie`) VALUES
(1, 'Noël 1', 'Description noël 1', 'noel1.jpg', 32),
(2, 'Noël 2', 'Description noël 2', 'noel2.jpg', 32),
(3, 'Chat 1', 'Description chat 1', 'chat1.jpg', 33),
(4, 'Chat 2', 'Description chat 2', 'chat2.jpg', 33),
(5, 'Cupcakes 1', 'Description cupcakes 1', 'cupcakes1.jpg', 34),
(6, 'Cupcakes 2', 'Description cupcakes 2', 'cupcakes2.jpg', 34),
(7, 'Cupcakes 3', 'Description cupcakes 3', 'cupcakes3.jpg', 34),
(8, 'Cupcakes 4', 'Description cupcakes 4', 'cupcakes4.jpg', 34);
